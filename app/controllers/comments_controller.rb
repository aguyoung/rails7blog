class CommentsController < ApplicationController
  ...
  before_action :set_post, only: %i[ index new show edit destroy ]
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_comments_path(id: @post.id), notice: "Comment was successfully destroyed." }
