...
class PostCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_category" do
    assert_difference("PostCategory.count") do
      post post_categories_url, params: { post_category: { category_id: @post_category.category_id, post_id: @post_category.post_id } }
    end
  ...
  test "should update post_category" do
    patch post_category_url(@post_category), params: { post_category: { category_id: @post_category.category_id, post_id: @post_category.post_id } }
